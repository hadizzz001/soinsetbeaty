export const site = {
  ...
  shortName: "Soins et Beauté",
  description:
    "Soins et Beauté is your go-to aesthetic clinic, offering premium skincare and aesthetic treatments performed by experienced professionals.",
  url: "https://soinsetbeaute.com",
  logo:
    "https://res.cloudinary.com/seukwo8g/image/upload/v1786881108/436803874_1184535092718167_1564630689125613085_n__1_-removebg-preview_t6o5xv.png",
  ogImage:
    "https://res.cloudinary.com/seukwo8g/image/upload/v1786881108/d69a38_mywojn.jpg",
  phone: "+961 3 885 683",
  whatsapp: "9613885683",
  waLink: "https://wa.me/9613885683",
  email: "najatehoyek@hotmail.com",
...
export const clinics = [
  ...
  },
  {
    ...
    address: "Mar Takla, Hazmieh, Lebanon",
    image:
      "https://images.unsplash.com/photo-1519415510236-718bdfcd89c1?q=80&w=1000&auto=format&fit=crop",
  },
  {
    name: "Mar Takla",
    phone: "+961 3 885 683",
...
export const services = [
  {
    key: "ems",
    title: "Sculpt & Firm: EMS + RF Body Contouring",
    name: "EMS Sculpting + RF",
    image:
      "https://res.cloudinary.com/seukwo8g/image/upload/v1786907529/EMS_Sculpting_ljvvee.jpg",
    description:
      "A powerful duo of electromagnetic muscle stimulation and radiofrequency that tones, tightens and reshapes your body — no downtime, no surgery, just visible results.",
    points: [
      "Builds muscle while melting stubborn fat",
      "Tightens skin for a firmer silhouette",
      "Fast sessions, zero recovery time",
    ],
  },
  {
    key: "hifu",
    ...
    points: [
      "Visible lift after just one session",
  ...
  },
  {
    ...
    points: [
      "Long-lasting, virtually painless results",
      "Safe for all skin types",
      "Quick sessions for any body area",
    ],
  },
  {
    key: "pressotherapy",
  ...
  },
  {
    ...
    name: "Microblading",
    image:
      "https://res.cloudinary.com/seukwo8g/image/upload/v1786907529/Microblading_clhbag.jpg",
    description:
      "Hand-drawn, hair-like strokes that fill and define your brows with a natural finish — wake up every day with perfectly shaped brows.",
    points: [
      "Natural, hair-like finish",
      "Tailored to your face shape",
      "Long-lasting semi-permanent results",
    ],
  },
  {
    key: "lipblush",
    title: "Effortless Color, All Day: Lip Blush & Eyeliner",
    name: "Lip Blush & Eyeliner",
    image:
      "https://res.cloudinary.com/seukwo8g/image/upload/v1786907529/Nails_Makeup_ivxlz2.jpg",
    description:
      "Semi-permanent lip tinting and precision eyeliner that enhance your natural features — wake up with color and definition, every single day.",
    points: [
      "Soft, buildable lip color",
      "Crisp, smudge-proof eyeliner",
  ...
  {
    key: "slimming",
    title: "Redefine Your Silhouette: Slimming Therapy",
    name: "Slimming",
    image:
      "https://res.cloudinary.com/seukwo8g/image/upload/v1786907528/Slimming_ykn0qt.jpg",
    description:
      "Targeted body-slimming sessions that reduce stubborn fat and refine your curves — a tailored plan designed around your goals.",
    points: [
      "Targets stubborn, hard-to-lose areas",
      "Customized to your body goals",
  ...
  },
  {
    ...
    points: [
      "Safe for all ink colors and skin tones",
      "Gradual, controlled fading process",
      "Minimal discomfort, expert supervision",
    ],
  },
  {
    key: "facials",
    title: "Glow From Within: Signature Facials",
    name: "Facials",
    image:
      "https://res.cloudinary.com/seukwo8g/image/upload/v1786907527/Facials_ss9nb6.jpg",
    description:
      "Deeply cleansing, hydrating and revitalizing facials tailored to your skin's needs — leave with a fresh, luminous complexion.",
    points: [
      "Deep cleansing & gentle exfoliation",
      "Hydration boost for a radiant glow",
...
export const testimonials = [
  {
    ...
    text: "I am so happy with the result! The team really has an eye for detail and made me feel at ease from the very first consultation. Thank you so much!",
  },
  {
    name: "Sophie M.",
    source: "Google Review",
    text: "A warm welcome and true professionalism. I feel heard and never pushed into unnecessary products or treatments. I will definitely be back!",
  },
  {
    name: "Julien P.",
    source: "Google Review",
    text: "After a few sessions, the difference in my skin is striking. An attentive team and results visible fast. I highly recommend this clinic.",
  },
  {
    name: "Élise B.",
    source: "Google Review",
    text: "This clinic was recommended to me and I was right to trust it. A tailored treatment, clear explanations and a natural result. Perfect.",
  },
];
